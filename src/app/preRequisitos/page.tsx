...
export default function PreRequisitos() {
    return (
        <div>
            <MiniTitulos titulo="Pré requisitos" />
            ...
            <BarraNavegacao paginaAnterior="/introducao" paginaSeguinte="/interface" nomePaginaA="Introdução" nomePaginaS="Interface e navegação" />
        </div>
    )
}